...
public class ThreadPoolDownloadService extends Service {
    ...
    public int onStartCommand(final Intent intent,
    	...
    	final ThreadPoolDownloadService thisService = this;
        Runnable downloadRunnable = new Runnable(){
        		@Override
	        	public void run(){
        			DownloadUtils.downloadAndRespond(thisService, intent.getData(), (Messenger)intent.getExtras().get(DownloadUtils.MESSENGER_KEY));
	        	}
        	};
