...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        case R.id.bound_sync_button:
        	...
        	try {
				String downloadFilePath = mDownloadCall.downloadImage(uri);
				displayBitmap(downloadFilePath);
			} catch (RemoteException e) {
				Log.e(TAG, e.getMessage());
				Toast.makeText(this, "Download sync failed!", Toast.LENGTH_LONG).show();
			}
            break;
        ...
        case R.id.bound_async_button:
        	...
        	try {
				...
				Log.e(TAG, e.getMessage());
				Toast.makeText(this, "Download async failed!", Toast.LENGTH_LONG).show();
			}
            break;
        }
    }
